...
var createTable = "CREATE TABLE anz_employee(id int(11) NOT NULL AUTO_INCREMENT,"+
    "name varchar(20) DEFAULT NULL,"+
    "salary float(11) DEFAULT NULL,"+
    "PRIMARY KEY (id)) ENGINE=InnoDB DEFAULT CHARSET=latin1";

var insertRecord = 'INSERT INTO anz_employee(name,salary) VALUE(?,?)';

var readTable = 'SELECT * FROM anz_employee';

var updateRecord = 'UPDATE anz_employee SET salary = ? WHERE name=?';

var deleteRecord = 'DELETE FROM anz_employee WHERE name=?';

var dropTable = 'DROP table anz_employee';
